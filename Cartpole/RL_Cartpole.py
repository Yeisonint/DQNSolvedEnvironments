...
# Creamos una funcion para obtener la recompensa aparte de la que pueda proporcionar el entorno
def rewardFunc(state, orgReward, rewardType = 0):
    # Observation: 
    #     Type: Box(4)
